...
pub struct ExpressionHotkeyManager {
    ...
    pub expression_switches: HashMap<Key, ExpressionState>,
    pub expression_holds: HashMap<Key, ExpressionState>,
}
...
impl ExpressionHotkeyManager {
    ...
    pub fn get_expression(&self, ctx: &Context) -> Option<&ExpressionState> {
    ...
    pub fn get_temporary_expression(&self, ctx: &Context) -> Option<&ExpressionState> {
